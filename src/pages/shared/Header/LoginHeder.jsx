...
const LoginHeder = () => {
    return (
        <div className="navbar bg-base-100 items-center z-10">
        ...
        <div className="navbar-center hidden lg:flex w-1/3">
            <input type="text" className='border border-black p-3 rounded-md w-4/6 z-10 outline-none' placeholder='Search Your Destination' />
        </div>
